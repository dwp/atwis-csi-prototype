...
app.post('/current/cases/personal-details/address', function (req, res) {
  // req.session.data = {}
  delete req.session.data.benefits;
  delete req.session.data.appointee;
  delete req.session.data.Searchligh;


    res.redirect('/current/cases/personal-details')
})
