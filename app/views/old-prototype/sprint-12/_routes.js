...
req.session.data['csi-info'][2]['firstname'] = req.session.data['firstname-change'];
...
req.session.data['csi-info'][2]['surname'] = req.session.data['surname-change'];
...
req.session.data['csi-info'][2]['dob-day'] = req.session.data['dob-change-day'];
...
req.session.data['csi-info'][2]['dob-month'] = req.session.data['dob-change-month'];
...
req.session.data['csi-info'][2]['dob-year'] = req.session.data['dob-change-year'];
...
req.session.data['csi-info'][2]['address-line-1'] = req.session.data['address-line-1-change'];
...
req.session.data['csi-info'][2]['company-name'] = req.session.data['company-name-change'];
...
req.session.data['csi-info'][2]['interviewer-name'] = req.session.data['interviewer-name-change'];
...
req.session.data['csi-info'][2]['company-contact-preference'] = req.session.data['company-contact-preference'];
...
req.session.data['csi-info'][2]['company-email-address'] = req.session.data['company-email-address-change'];
...
req.session.data['csi-info'][2]['company-phone'] = req.session.data['company-phone-change'];
...
req.session.data['csi-info'][2]['company-address-line-one'] = req.session.data['company-address-line-one-change'];
...
req.session.data['csi-info'][2]['company-address-town'] = req.session.data['company-address-town-change'];
...
req.session.data['csi-info'][2]['company-address-county'] = req.session.data['company-address-county-change'];
...
req.session.data['csi-info'][2]['company-address-postcode'] = req.session.data['company-address-postcode-change'];
...
req.session.data['csi-info'][2]['duration'] = req.session.data['duration-change'];
...
req.session.data['csi-info'][2]['condition'] = req.session.data['condition-change'];
...
req.session.data['csi-info'][2]['interview-date-day'] = req.session.data['interview-date-change-day'];
...
req.session.data['csi-info'][2]['interview-date-month'] = req.session.data['interview-date-change-month'];
...
req.session.data['csi-info'][2]['interview-date-year'] = req.session.data['interview-date-change-year'];
...
req.session.data['csi-info'][2]['support-worker-pay'] = req.session.data['support-worker-pay-change'];
...
router.all('/agreed/csi/5-payments/invoice-passthrough-router', function(req, res, next){
  ...
  req.session.data['invoice-value'] = req.session.data['csi-info'][2]['support-worker-pay'];
