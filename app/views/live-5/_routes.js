...
/* CHECK ROUTER TO MAKE THE JOURNEY WITH NOTES MORE ROBUST */
  ...
  router.post('/live-5/cases/searchlight/benefits/check', function(req, res, next){ 
  ...
     case "none" :  return res.redirect("/live-5/claim#your-tasks"); next(); break;
     default: continue;
     }
     break;
    }
  ...
   }
  return res.redirect("/live-5/claim#your-tasks"); next();
  })
